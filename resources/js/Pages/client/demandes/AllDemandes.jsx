...
<ClientLayout
        header={
                ...
                <div className="">
                    <Button onClick={() => router.visit(route('demande.index'))} variant="outline" className="rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-500">Nouvelle demande</Button>
                </div>
                                        ...
                                        {filteredDemandes.map((demande) => (
                                            <tr key={demande.id} className={selectedItems.includes(demande.id) ? 'bg-gray-50' : ''}>
                                                ...
                                                <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium flex gap-1 items-center">
                                                    <a
                                                        href={route('client.demandes.edit', demande.id)}
